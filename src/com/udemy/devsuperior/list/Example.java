package com.udemy.devsuperior.list;
...
public class Example {
	...
	public static void main(String[] args) {
		...
		// Laço for each, cria uma variável e armazena o valor de list - Imprimindo os valores armazenados na list
		for (String x : list) {
		...
		// Remove o elemento fazendo a comparação, e remove o valor inserido caso ele exista na lista
		list.remove("Marley");
